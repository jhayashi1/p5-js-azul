let genomeInputsN = (NUM_FACTORIES * 4) + (48 * 4);	//48 = 15 tile lines, 25 wall tiles, 7 floor tiles, 1 score
let genomeOutputN = 3;	//One output for factory to pick from, color to pick, line to put it on
let showBest = true;
